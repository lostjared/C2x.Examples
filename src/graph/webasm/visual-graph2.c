...
static constexpr int NODE_RADIUS = 21;
static constexpr int FONT_SIZE = 20;
static constexpr int FONT_SIZE_LG = 30;
static constexpr int PATH_THICKNESS = 5;
...
int main(void) {
    ...
    font_lg = TTF_OpenFont("font.ttf", FONT_SIZE_LG);
    if (font_lg == nullptr)
        font_lg = font;

    target_node = (int)node_count - 1;
    ...
    positions = malloc(node_count * sizeof(Vec2));
